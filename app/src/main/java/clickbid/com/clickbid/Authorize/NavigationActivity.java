package clickbid.com.clickbid.Authorize;
...
import clickbid.com.clickbid.Activities.CBLandingPage;
import clickbid.com.clickbid.Authorize.Fragment.LogoutRetainedFragment;
import clickbid.com.clickbid.Authorize.Fragment.TransactionFragment;
import clickbid.com.clickbid.Authorize.Fragment.TransactionRetainedFragment;
import clickbid.com.clickbid.Authorize.services.AnetIntentService;
        ...
        switch (fragmentTag) {
            case TRANSACTION_FRAGMENT_TAG:
                if (transactionResult != null && !transactionResult.isApproved()) {
                    ...
                    System.out.println("Result :--"+transactionResult);
                    if (transactionResult != null && transactionResult.isOk()) {
                        ...
                        System.out.println("Transaction Amount :-"+transactionAmount+"Result :-"+transactionResult.getAccountNumber()+"TransID:-"+transactionResult.getTransId());
                        Intent intent = new Intent(NavigationActivity.this, CBLandingPage.class);
                        startActivity(intent);
